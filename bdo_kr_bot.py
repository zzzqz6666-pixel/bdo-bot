...
def get_browser_page():
    ...
    _browser = _playwright.chromium.launch(
        headless=True if BROWSER_HEADLESS or os.getenv("RAILWAY_MODE", "false").lower() == "true" else False,
        args=launch_args,
    )
    ...
    _page.set_default_timeout(BROWSER_WAIT_SECONDS * 1000)
    _page.set_default_navigation_timeout(BROWSER_PAGE_TIMEOUT * 1000)
...
def fetch_guild_html_browser_sync(guild_name: str) -> tuple[str, str]:
    ...
    with _browser_lock:
        ...
        try:
            ...
            page.goto(url, wait_until="domcontentloaded", timeout=BROWSER_PAGE_TIMEOUT * 1000)

            try:
                page.wait_for_selector(
                    ".box_list_area a[href*='Adventure/Profile'], .box_list_area a[href*='/Adventure/Profile']",
            ...
            time.sleep(max(BROWSER_COOLDOWN_SECONDS, 3.0))
            html = page.content()
