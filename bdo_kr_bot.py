...
OVERDUE_SCAN_MULTIPLIER = float(os.getenv("OVERDUE_SCAN_MULTIPLIER", "1.5"))
CATCHUP_SCAN_BATCH_LIMIT = int(os.getenv("CATCHUP_SCAN_BATCH_LIMIT", "8"))
...
BROWSER_COOLDOWN_SECONDS = float(os.getenv("BROWSER_COOLDOWN_SECONDS", "0.2"))
